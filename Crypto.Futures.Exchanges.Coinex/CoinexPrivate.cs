...
namespace Crypto.Futures.Exchanges.Coinex
{
    ...
    internal class CoinexPrivate
    {

        private const string HEADER_API = "X-COINEX-KEY";
        private const string HEADER_TIME = "X-COINEX-TIMESTAMP";
        private const string HEADER_SIGNATURE = "X-COINEX-SIGN";
        /*
        ...
        */
        ...
        public CoinexPrivate(IFuturesExchange oExchange)
        {
            Exchange = oExchange;
        }
